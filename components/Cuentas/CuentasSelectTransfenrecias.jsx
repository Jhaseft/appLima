        ...
        {selected ? (
          <View className="flex-row items-center gap-2 flex-1">
            ...
            <View className="flex-1">
              ...
              <Text className="text-text-muted text-xs font-sans">{selected.account_number}</Text>
            </View>
          </View>
        ) : (
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-text-muted text-xs font-sans">{item.account_number}</Text>
                  </View>
